...
public class ControlSurfaces : MonoBehaviour
{
    ...
    private FlyingObject PlanePhysics;
    ...
    void Start()
    {
        ...
        PlanePhysics = GetComponent<FlyingObject>();
    ...
    void Update()
    {
        ...
        if (!Input.GetKey(KeyCode.E) & !Input.GetKey(KeyCode.Q) & (CurrentLeftAileronAngle != AileronsNeutralAngle | 
            CurrentRightAileronAngle != AileronsNeutralAngle) & _Roll == 0)
